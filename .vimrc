...
" VIM-Rust 模式配置
" autocmd FileType rust nmap gr <Plug>(coc-references)
" autocmd FileType rust nmap gd <Plug>(coc-definition)
" autocmd FileType rust nmap gi <Plug>(coc-implementation)
" autocmd FileType rust nmap rn <Plug>(coc-rename)
" LocationList 浏览快捷键设置
...
" 其他支持的编程语言
autocmd FileType go,rust,c,cpp,objc,objcpp,cuda,java,javascript,python,typescript nmap gr <Plug>(coc-references)
...
" rust 配置 
" let g:ycm_rust_toolchain_root = '/Users/lsm/.rustup/toolchains/stable-x86_64-apple-darwin'
" let g:ycm_rust_src_path = '/Users/lsm/.rustup/toolchains/stable-x86_64-apple-darwin/lib/rustlib/src/rust/src'
